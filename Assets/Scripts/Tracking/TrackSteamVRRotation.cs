...
public class TrackSteamVRRotation : MonoBehaviour
{

    /*
     * Mostly just a copy of SteamVR_TrackedObject.cs
     */
    ...
    private void OnNewPoses(params object[] args)
    {
        ...
        var rot = Quaternion.Euler(pose.rot.eulerAngles + RotationOffset);
