...
{
    class OvrCameraFeedVive : MonoBehaviour
    {
        // Camera GameObject
        ...
        void Start()
        {
            ...
            CameraPlaneLeft = transform.FindChild("LeftImagePlane").gameObject;
            CameraPlaneRight = transform.FindChild("RightImagePlane").gameObject;
            ...
            CameraPlaneLeft.transform.localScale = new Vector3(-0.91f, 1.0f, 1.0f);
            CameraPlaneRight.transform.localScale = new Vector3(-0.91f, 1.0f, 1.0f);
            CameraPlaneLeft.transform.localPosition = new Vector3(-0.04f, 0.0f, defaultFloatpoint + IMAGE_ZOFFSET);
            CameraPlaneRight.transform.localPosition = new Vector3(0.04f, 0.0f, defaultFloatpoint + IMAGE_ZOFFSET);
