...
%ignore Leap::EdgeSample::EdgeSample(EdgeSampleImplementation*);
%ignore Leap::Tip::Tip(TipImplementation*);
...
%constattrib( Leap::EdgeSampleList, int, count );
%constattrib( Leap::TipList, int, count );
...
%constattrib( Leap::EdgeSampleList, bool, isEmpty );
%constattrib( Leap::TipList, bool, isEmpty );
...
%leapattrib( Leap::Frame, EdgeSampleList, edgeSamples );
%leapattrib( Leap::Frame, TipList, tips );
...
%leapattrib( Leap::EdgeSample, Vector, position );
%constattrib( Leap::EdgeSample, float, weight );
%constattrib( Leap::EdgeSample, int32_t, idLeft );
%constattrib( Leap::EdgeSample, int32_t, idRight );
%constattrib( Leap::EdgeSample, bool, isValid );

%leapattrib( Leap::Tip, Vector, position );
%constattrib( Leap::Tip, float, radius );
%constattrib( Leap::Tip, bool, isValid );
...
%staticattrib( Leap::EdgeSample, static const EdgeSample&, invalid );
%staticattrib( Leap::Tip, static const Tip&, invalid );
...
%leap_list_helper(EdgeSample);
%leap_list_helper(Tip);
