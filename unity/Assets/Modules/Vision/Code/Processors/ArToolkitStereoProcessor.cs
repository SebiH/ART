...
{
    public class ArToolkitStereoProcessor : IProcessor
    {
        ...
        public void Register(int pipelineId)
        {
            ...
            var config = new ArToolkitInitialSettings
            {
                ...
                calibration_stereo = Path.Combine(globalDataPath, "ovrvision_transL2R.dat")
            };

            _id = ImageProcessing.AddArToolkitStereoProcessor(pipelineId, JsonUtility.ToJson(config));
        ...
        private struct ArToolkitInitialSettings
        {
            ...
            public string calibration_stereo;
        }
    }
}
