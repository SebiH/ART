...
namespace Assets.Modules.Surfaces.Scripts.Manager
{
    public class DummySurface : MonoBehaviour
    {
        ...
        private void ApplyChanges()
        {
            ...
            _createdSurface.SetCornerPosition(Corner.TopLeft, TopLeftCorner.position);
            _createdSurface.SetCornerPosition(Corner.BottomLeft, BottomLeftCorner.position);
            _createdSurface.SetCornerPosition(Corner.BottomRight, BottomRightCorner.position);
            _createdSurface.SetCornerPosition(Corner.TopRight, TopRightCorner.position);
