/**
 *	Adapted from Daqri's ARToolkit5 - calib_stereo.cpp
 *	Changes from original script:
 *		- Remove OpenGL dependency (don't want to include OpenGL solely for calibration..)
 *		- Able to use internal FrameSource, since some cameras can't be opened as webcam (e.g. OVRVision Pro)
 *		- Wrapped in class / C++
 *		- Use CalibrationSettings struct instead of #defining options
 *		- Windows only
 */
