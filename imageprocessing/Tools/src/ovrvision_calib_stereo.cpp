/*
 *	Adapted from calib_camera.cpp for OVRVision cameras
 */
...
static int                  calibImageNum = 0;
static int                  capturedImageNum = 0;
static float                patternWidth = 0.0f;
static int                  cornerFlag = 0;
static CvPoint2D32f        *cornersL;
static CvPoint2D32f        *cornersR;
static IplImage            *calibImageL;
static IplImage            *calibImageR;
static ICPCalibDataT       *calibData;
static ICP3DCoordT         *worldCoord;

static AR2VideoParamT      *vidL;
static AR2VideoParamT      *vidR;
static int                  xsizeL, ysizeL;
static int                  xsizeR, ysizeR;
static int                  pixFormatL;
static int                  pixFormatR;
static ARParam              paramL;
